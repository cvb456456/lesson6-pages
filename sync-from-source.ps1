...
$sourceSongHoshifuruDialogue = Join-Path $sourceRoot "song-hoshifuru-umi-dialogue-study.html"
...
$targetSongHoshifuruDialogue = Join-Path $publicRoot "song-hoshifuru-umi-dialogue-study.html"
...
foreach ($requiredFile in @($sourceIndex, $sourceDialogue, $sourceReading, $sourceLesson7Grammar, $sourceLesson7Dialogue, $sourceLesson7Email, $sourceSongKatachi, $sourceSongAi, $sourceSongMadarai, $sourceSongShunkan, $sourceSongEx, $sourceSongHoshifuru, $sourceSongHoshifuruDialogue, $sourceImage, $sourceLesson7Image, $sourceLesson7DialogueImage, $sourceLesson7EmailImage, $sourcePlayerScript, $sourcePlayerStyle)) {
...
Copy-Item -LiteralPath $sourceSongHoshifuruDialogue -Destination $targetSongHoshifuruDialogue -Force
...
Write-Host "  $targetSongHoshifuruDialogue"
